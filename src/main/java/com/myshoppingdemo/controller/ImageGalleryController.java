...
import com.myshoppingdemo.service.ImageGalleryService;
...
public class ImageGalleryController {
    ...
    public @ResponseBody ResponseEntity<?> createProduct(@RequestParam("name") String name, @RequestParam("price") double price,
        ...
        try {
//            we are passing as an argument to getRealPath(), so it will return the complete path where
//            you have created a workspace in your local system.
          String uploadDirectory = request.getServletContext().getRealPath(uploadFolder);
          log.info("uploadDirectory:: " + uploadDirectory);
//            file.getOriginalFilename(): It will return the actual name of the product image such as image.png,
//                    it depends on the name of the product you have uploaded.
          String fileName = file.getOriginalFilename();
//            It will return the exact location on your system where the uploaded image has been saved.
...
//                      "Sorry! Filename contains invalid path sequence \" + fileName");
    ...
    throws ServletException, IOException {
        log.info("Id :: " + id);
        imageGallery = imageGalleryService.getImageId(id);
